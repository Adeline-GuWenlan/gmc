...
#SBATCH --mem=24G
#SBATCH -t 12:00:00
#SBATCH -o /scratch/sy2366/Project/splathjb/splatc_atlas/outputs/p0r3_cleanroom.log
# Layer-2 acceptance v3 (round-7): three gates with INDIVIDUALLY captured
# exit codes, then a machine receipt (write_receipt.py) recording exactly
# what was verified.  Own allocation (borrowed-cgroup lesson).
set -u
PROJ=/scratch/sy2366/Project/splathjb
CR=$PROJ/cleanroom_p0r3
